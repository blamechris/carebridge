...
- **Chart Keeper** should verify claims against FHIR R4 standards and clinical data modeling best practices.
- **Oversight** should assess LLM prompt safety, hallucination risk in clinical contexts, and deterministic rule coverage before AI review.
...
/swarm-audit "the clinical rules engine in services/ai-oversight" 4
/swarm-audit docs/rfc-clinical-data-schema.md
/swarm-audit "patient data flow across api-gateway and clinician-portal" 6
```
